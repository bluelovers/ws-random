...
export { bates, bernoulli, binomial, exponential, geometric, irwinHall, logNormal, normal, pareto, poisson, uniform, uniformBoolean, uniformInt, uniformByte, bytes, arrayIndex, arrayShuffle, arrayUnique, itemByWeight, charID, sumFloat, sumInt, uuidv4, };
