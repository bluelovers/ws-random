...
var libRMath__namespace = /*#__PURE__*/_interopNamespace(libRMath);
var isExtendsOf__default = /*#__PURE__*/_interopDefaultLegacy(isExtendsOf);
...
class RandomRngWithLibRMath extends rngAbstract.RNG {
  ...
  _init(seed, opts, ...argv) {
    if (seed instanceof libRMath__namespace.IRNG) {
      ...
      this._rng = opts;
    } else if (seed && isExtendsOf__default["default"](seed, libRMath__namespace.IRNG)) {
      this._rng = new seed(this._seedNum(opts));
    } else if (opts && isExtendsOf__default["default"](opts, libRMath__namespace.IRNG)) {
